...
class UserTest < ActiveSupport::TestCase
  ...
  test "email é único" do
    user = User.create(name: "Darth Vader", email: "darthvader@example.com", password: "secret", password_confirmation: "secret")
    other_user = User.create(email: "darthvader@example.com")
